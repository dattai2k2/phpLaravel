                    ...
                    <div class="aa-header-top-area">
                        ...
                        <div class="aa-header-top-right">
                            <ul class="aa-head-top-nav-right">
                                <li><a href="{{route('order.history')}}">My Account</a></li>
                    ...
                    <div class="aa-header-bottom-area">
                        ...
                        <div class="aa-logo">
                            ...
                            <a href="{{ route('home')}}">
                                ...
                                <p>E <strong>Shop</strong> <span>Your Shopping Partner</span></p>
                            </a>
                            <!-- img based logo -->
                            ...
                            <div class="aa-cartbox-summary">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a class="aa-remove-product" href="{{route('cart.remove',$cart->id)}}"><span class="fa fa-times"></span></a>
                                    </li>
                                    @endforeach
                                    <li>
