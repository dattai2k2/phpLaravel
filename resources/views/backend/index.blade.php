...
<script src="{{ URL::asset('public/assets/backend/assets/js/core/popper.min.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset('public/assets/backend/assets/js/core/bootstrap.min.js') }}" type="text/javascript"></script>
...
<!-- <script type="text/javascript">
    $(document).ready(function() {
        // Javascript method's body can be found in assets/backend/assets/js/demos.js
