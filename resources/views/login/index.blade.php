			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<ul class="nav" id="myTab" role="tablist">
						...
						<a class="nav-link active" href="{{route('login')}}" role="tab"
							aria-controls="tab1" aria-selected="true">SIGN IN</a>
						</li>
						<li class="nav-item" role="presentation">
						<a class="nav-link" href="{{route('signup')}}" role="tab"
							aria-controls="tab2" aria-selected="false">REGISTER</a>
						</li>
					</ul>
				</div>
			</div>
